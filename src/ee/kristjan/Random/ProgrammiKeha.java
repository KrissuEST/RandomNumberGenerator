...
//		}
//		return output;
		String arrayString = Arrays.toString(arrayRand);     // toString - teeb asja stringiks
		return arrayString.substring(1, arrayString.length() -1);    //subString - tekitab uue stringi
	}
...
//	    	System.out.println(printOut(a_Sorted));
	    	...
	    	//Siin on kogu output faili kirjutamise osa.
//		    try {
